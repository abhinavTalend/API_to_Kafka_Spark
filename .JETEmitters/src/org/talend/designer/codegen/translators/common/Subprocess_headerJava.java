...
public class Subprocess_headerJava
{
  ...
  protected final String TEXT_203 = "_\" + subJobPidCounter.getAndIncrement());" + NL + "\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_27);
    stringBuffer.append(TalendTextUtils.escapeJavaText(TalendTextUtils.removeQuotes(column.getOriginalDbColumnName())));
    stringBuffer.append(TEXT_28);
     } 
