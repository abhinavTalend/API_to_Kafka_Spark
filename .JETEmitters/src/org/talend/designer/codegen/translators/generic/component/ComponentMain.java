...
public class ComponentMain
{
  ...
  protected final String TEXT_26 = ".schema();" + NL + "                    // set name" + NL + "                    \t\t\t\t\tif(\"true\".equals(dynamicField_";
  protected final String TEXT_27 = ".getProp(\"ENABLE_SPECIAL_TABLENAME\"))){" + NL + "\t\t\t\t\t    dynamicMetadata_";
  protected final String TEXT_28 = ".setName(dynamicField_";
  protected final String TEXT_29 = ".getProp(\"talend.field.dbColumnName\"));" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t    dynamicMetadata_";
  protected final String TEXT_30 = ".name());" + NL + "\t\t\t\t\t}" + NL + "                    // set db name" + NL + "                    dynamicMetadata_";
  protected final String TEXT_31 = ".setDbName(dynamicField_";
  protected final String TEXT_32 = ".name());" + NL + "                    // set nullable" + NL + "                    if (org.talend.daikon.avro.AvroUtils.isNullable(dynamicFieldSchema_";
  protected final String TEXT_33 = ")) {" + NL + "                        dynamicMetadata_";
  protected final String TEXT_34 = ".setNullable(true);" + NL + "                    }" + NL + "                    // set type" + NL + "                    String talendType_";
  protected final String TEXT_35 = " = org.talend.codegen.converter.TypeConverter.avroToDi(dynamicFieldSchema_";
  protected final String TEXT_36 = ");" + NL + "                    dynamicMetadata_";
  protected final String TEXT_37 = ".setType(talendType_";
  protected final String TEXT_38 = ");" + NL + "                    // set pattern" + NL + "                    String pattern_";
  ...
  protected final String TEXT_49 = ".getProp(org.talend.daikon.avro.SchemaConstants.TALEND_COLUMN_DB_LENGTH);" + NL + "                    if (length_";
  protected final String TEXT_50 = " != null) {" + NL + "                        dynamicMetadata_";
  protected final String TEXT_51 = ".setLength(Integer.parseInt(String.valueOf(length_";
  protected final String TEXT_52 = ")));" + NL + "                    }" + NL + "                    // set DbType" + NL + "                    Object dbType_";
  protected final String TEXT_53 = ".getProp(org.talend.daikon.avro.SchemaConstants.TALEND_COLUMN_DB_TYPE);" + NL + "                    if (dbType_";
  protected final String TEXT_54 = ".setDbType(String.valueOf(dbType_";
  protected final String TEXT_55 = "));" + NL + "                    }" + NL + "                    // set precision" + NL + "                    Object precision_";
  protected final String TEXT_56 = ".getProp(org.talend.daikon.avro.SchemaConstants.TALEND_COLUMN_PRECISION); " + NL + "                    if (precision_";
  ...
  protected final String TEXT_63 = ".clearColumnValues();";
  protected final String TEXT_64 = NL + "                java.util.Map<String, Object> dynamicValue_";
  protected final String TEXT_65 = " = (java.util.Map<String, Object>) ";
  protected final String TEXT_66 = ".get(";
  protected final String TEXT_67 = ");" + NL + "                for (java.util.Map.Entry<String, Object> dynamicValueEntry_";
  protected final String TEXT_68 = " : dynamicValue_";
  protected final String TEXT_69 = ".entrySet()) {";
  protected final String TEXT_70 = ".addColumnValue(dynamicValueEntry_";
  ...
  protected final String TEXT_130 = " != null && incomingEnforcer_";
  protected final String TEXT_131 = ".getDesignSchema().getField(\"";
  protected final String TEXT_132 = "\") == null){" + NL + "                        incomingEnforcer_";
  protected final String TEXT_133 = ".addIncomingNodeField(\"";
  protected final String TEXT_134 = "\", ((Object) ";
  protected final String TEXT_135 = ").getClass().getCanonicalName());" + NL + "                        shouldCreateRuntimeSchemaForIncomingNode = true;" + NL + "                    }";
  protected final String TEXT_136 = NL + "            if (shouldCreateRuntimeSchemaForIncomingNode && incomingEnforcer_";
  protected final String TEXT_137 = " != null){" + NL + "                incomingEnforcer_";
  protected final String TEXT_138 = ".createRuntimeSchema();" + NL + "            }";
  protected final String TEXT_139 = NL + "            if (incomingEnforcer_";
  protected final String TEXT_140 = " != null && !incomingEnforcer_";
  protected final String TEXT_141 = ".areDynamicFieldsInitialized()) {" + NL + "                // Initialize the dynamic columns when they are first encountered." + NL + "                for (routines.system.DynamicMetadata dm_";
  protected final String TEXT_142 = " : ";
  protected final String TEXT_143 = ".metadatas) {" + NL + "                    incomingEnforcer_";
  protected final String TEXT_144 = ".addDynamicField(" + NL + "                            dm_";
  protected final String TEXT_145 = ".getName()," + NL + "                            dm_";
  protected final String TEXT_146 = ".getType()," + NL + "                            dm_";
  protected final String TEXT_147 = ".getLogicalType()," + NL + "                            dm_";
  protected final String TEXT_148 = ".getFormat()," + NL + "                            dm_";
  protected final String TEXT_149 = ".getDescription()," + NL + "                            dm_";
  protected final String TEXT_150 = ".isNullable()," + NL + "                            dm_";
  protected final String TEXT_151 = ".isKey());" + NL + "                }" + NL + "                incomingEnforcer_";
  protected final String TEXT_152 = NL + "        if (incomingEnforcer_";
  protected final String TEXT_153 = " != null) {" + NL + "            incomingEnforcer_";
  protected final String TEXT_154 = ".createNewRecord();" + NL + "        }";
  protected final String TEXT_155 = NL + "                //skip the put action if the input column doesn't appear in component runtime schema" + NL + "                if (incomingEnforcer_";
  protected final String TEXT_156 = ".getRuntimeSchema().getField(\"";
  protected final String TEXT_157 = "\") != null){" + NL + "                    incomingEnforcer_";
  protected final String TEXT_158 = ".put(\"";
  protected final String TEXT_159 = "\", ";
  protected final String TEXT_160 = ");" + NL + "                }";
  protected final String TEXT_161 = NL + "                if (incomingEnforcer_";
  protected final String TEXT_162 = " != null) {" + NL + "                    for (int i = 0; i < ";
  protected final String TEXT_163 = ".getColumnCount(); i++) {" + NL + "                        incomingEnforcer_";
  protected final String TEXT_164 = ".put(";
  protected final String TEXT_165 = ".getColumnMetadata(i).getName(),";
  protected final String TEXT_166 = NL + "                                ";
  protected final String TEXT_167 = ".getColumnValue(i));" + NL + "                    }" + NL + "                }";
  protected final String TEXT_168 = NL + "        " + NL + "        org.apache.avro.generic.IndexedRecord data_";
  protected final String TEXT_169 = " = null;" + NL + "        if (incomingEnforcer_";
  protected final String TEXT_170 = " != null) {" + NL + "            data_";
  protected final String TEXT_171 = " = incomingEnforcer_";
  protected final String TEXT_172 = ".getCurrentRecord();" + NL + "        }" + NL + "        ";
  protected final String TEXT_173 = NL + "        \tglobalMap.put(buffersSizeKey_";
  protected final String TEXT_174 = ", buffersSize_";
  protected final String TEXT_175 = ");" + NL + "        \t";
  protected final String TEXT_176 = NL + "        if (writer_";
  protected final String TEXT_177 = " != null && data_";
  protected final String TEXT_178 = " != null) {" + NL + "        \twriter_";
  protected final String TEXT_179 = ".write(data_";
  protected final String TEXT_180 = ");" + NL + "        }" + NL + "        " + NL + "        nb_line_";
  protected final String TEXT_181 = "++;";
  protected final String TEXT_182 = NL + "        \tif(!(writer_";
  protected final String TEXT_183 = " instanceof org.talend.components.api.component.runtime.WriterWithFeedback)) {" + NL + "          \t\t// For no feedback writer,just pass the input record to the output" + NL + "          \t\tif (data_";
  protected final String TEXT_184 = "!=null) {" + NL + "          \t\t\toutgoingMainRecordsList_";
  protected final String TEXT_185 = " = java.util.Arrays.asList(data_";
