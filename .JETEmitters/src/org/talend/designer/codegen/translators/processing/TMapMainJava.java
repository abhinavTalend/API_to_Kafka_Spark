...
public class TMapMainJava {
  ...
  protected final String TEXT_50 = NL + "\t\t// ###############################" + NL + "\t\t// # Input tables (lookups)" + NL + "\t\t";
  protected final String TEXT_51 = NL + "\t\tboolean ";
  protected final String TEXT_52 = " = false;" + NL + "\t\tboolean ";
  protected final String TEXT_53 = NL + "\t\t              " + NL + "\t\t\t   \t  \t\t  if(" + NL + " \t\t\t\t  \t\t  \t\t\t";
  protected final String TEXT_54 = NL + "\t  \t  \t\t  \t\t\t\t) { // G_TM_M_280" + NL + "" + NL + "\t\t\t\t\t\t\t // CALL close main tMap filter for table '";
  protected final String TEXT_55 = "'" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_56 = NL + NL + "\t\t\t\t///////////////////////////////////////////////" + NL + "\t\t\t\t// Starting Lookup Table \"";
  protected final String TEXT_57 = "\" " + NL + "\t\t\t\t///////////////////////////////////////////////" + NL + "" + NL + "" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_58 = "\t\t\t\t" + NL + "\t\t\t\tSortableRow_";
  protected final String TEXT_59 = " rsc_";
  protected final String TEXT_60 = ";" + NL + "\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_62 = ".initGet();" + NL + "\t\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t\t" + NL + "" + NL + "\t\t\t\tfsi_";
  protected final String TEXT_64 = ".initGet();" + NL + "" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_176 = NL + NL + "\t\t\t\t\t\t\t\twhile ((tHash_Lookup_";
  protected final String TEXT_177 = ".hasNext()) || forceLoop";
  protected final String TEXT_178 = ") { // G_TM_M_043" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_249 = NL + "\t    \t        \t} // G_TM_M_250 loop \"";
  protected final String TEXT_250 = "\"" + NL + "" + NL + "\t            \t\t";
  protected final String TEXT_251 = NL + "\t            \t" + NL + "\t           \t";
  protected final String TEXT_252 = NL + "\t            \t" + NL + "\t            \t" + NL + "\t            ";
  protected final String TEXT_253 = "\t\t\t\t" + NL + "\t\t\t\t\tfsi_";
  protected final String TEXT_254 = ".endGet();" + NL + "\t\t\t\t";
  protected final String TEXT_255 = " " + NL + "\t            \t" + NL + "\t            \tfsi_";
  protected final String TEXT_256 = ".endPut();" + NL + "\t            \t" + NL + "\t\t\t\t";
  protected final String TEXT_257 = NL + "                try {";
  protected final String TEXT_258 = "// ###############################";
  protected final String TEXT_259 = NL + "        { // start of Var scope" + NL + "        " + NL + "\t        // ###############################" + NL + "        \t// # Vars tables" + NL + "        ";
  protected final String TEXT_260 = NL + "        // ###############################" + NL + "        // # Output tables";
